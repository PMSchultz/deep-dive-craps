...
/** Fragment, not full sentence (let alone paragraph).*/
   ...
   * eg Simulates multiple plays of Craps, tallying the pass line bet outcomes
   * methods must include a param tag for each
  ...
  public static void main(String[] args) {
    ...
    System.out.printf(OUTCOME_MESSAGE, plays, wins, losses, 100.0 * wins / plays);
  }
